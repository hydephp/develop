		...
		<div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
			...
			<ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
				<li class="items-center">
					<a href="../auth/login.html"
						...
						<i class="fas fa-fingerprint text-slate-300 mr-2 text-sm"></i> Login </a>
				</li>
				<li class="items-center">
					<a href="../auth/register.html"
						class="text-slate-700 hover:text-slate-500 text-xs uppercase py-3 font-bold block">
						<i class="fas fa-clipboard-list text-slate-300 mr-2 text-sm"></i> Register </a>
				</li>
			</ul>
			<!-- Divider -->
			<hr class="my-4 md:min-w-full" />
			...
			<ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
				<li class="items-center">
					<a href="../landing.html"
						class="text-slate-700 hover:text-slate-500 text-xs uppercase py-3 font-bold block">
						<i class="fas fa-newspaper text-slate-300 mr-2 text-sm"></i> Landing Page </a>
				</li>
				<li class="items-center">
					<a href="../profile.html"
						class="text-slate-700 hover:text-slate-500 text-xs uppercase py-3 font-bold block">
						<i class="fas fa-user-circle text-slate-300 mr-2 text-sm"></i> Profile Page </a>
				</li>
			</ul>
			<!-- Divider -->
			<hr class="my-4 md:min-w-full" />
