...
class ValidatePublicationsCommand extends ValidatingCommand
{
    ...
    {
        $this->results[$publicationType->getIdentifier()][$publication->getIdentifier()] = ['passed'];
    ...
    {
        $this->results[$publicationType->getIdentifier()][$publication->getIdentifier()]['fields'] = ['passed'];
        $this->countFields++;
        ...
        try {
            ...
            $this->results[$publicationType->getIdentifier()][$publication->getIdentifier()]['fields'][$fieldName]['errors'][] = $exception->getMessage();
