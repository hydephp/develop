...
class ValidatePublicationsCommand extends ValidatingCommand
{
    ...
    {
        $this->results['publicationTypes'][$publicationType->getIdentifier()][$publication->getIdentifier()] = ['passed'];
        ...
        foreach ($publication->matter->data as $key => $value) {
            $this->results['publicationTypes'][$publicationType->getIdentifier()][$publication->getIdentifier()]['warnings'][] = "Field [$key] is not defined in publication type";
            $this->countWarnings++;
    ...
    {
        $this->results['publicationTypes'][$publicationType->getIdentifier()][$publication->getIdentifier()]['fields'] = ['passed'];
        $this->countFields++;
        ...
        try {
            ...
            $this->results['publicationTypes'][$publicationType->getIdentifier()][$publication->getIdentifier()]['fields'][$fieldName]['errors'][] = $exception->getMessage();
