...
<ul id="sidebar-navigation-items" role="list">
	@foreach ($sidebar->getGroups() as $group)
		...
		<header class="sidebar-group-header p-2 px-4 flex justify-between items-center group" @click="groupOpen = ! groupOpen">
		...
		<ul class="sidebar-group-list ml-4 pl-4 mb-2" role="list" x-show="groupOpen">
