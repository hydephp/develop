...
@php
    ...
    $activeListClasses = $grouped ? $grouped_activeListClasses : $standard_activeListClasses;
    $activeItemClasses = $grouped ? $grouped_activeItemClasses : $standard_activeItemClasses;
    $itemClasses = $grouped ? $grouped_itemClasses : $standard_itemClasses;
@endphp
