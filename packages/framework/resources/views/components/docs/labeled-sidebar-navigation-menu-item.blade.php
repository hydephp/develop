...
<li @class([ 'sidebar-navigation-item -ml-4 pl-4' , 'active -ml-8 pl-8 bg-black/5 dark:bg-black/10'=> $active]) {!! $active ? '' : '' !!} role="listitem">
	@if(! $active)
	...
	@else
	<a class="-ml-8 pl-4 py-1 px-2  block  text-indigo-600 border-l-[0.325rem] border-indigo-500 transition-colors duration-300	ease-in-out	hover:bg-black/10"
