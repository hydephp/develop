...
<body id="lagrafo-app" class="bg-white dark:bg-gray-900">
	...
	<nav id="mobile-navigation">
		<strong class="mr-auto">
			@if(\Hyde\Framework\Models\Pages\DocumentationPage::indexPath() !== false)
			<a href="{{ Hyde::relativeLink(\Hyde\Framework\Models\Pages\DocumentationPage::indexPath(), $currentPage) }}">
