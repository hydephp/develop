...
class Author
{
     ...
     */
    public static function create(#[Deprecated]string $username, ?string $name = null, ?string $website = null, ?string $bio = null, ?string $avatar = null, ?array $socials = null): PostAuthor
    {
