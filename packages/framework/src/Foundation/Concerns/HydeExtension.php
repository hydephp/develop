...
abstract class HydeExtension
{
     ...
     *
     * Register fallback pages after every extension has completed normal page discovery.
     * Default handlers themselves continue to run in extension registration order.
     */
