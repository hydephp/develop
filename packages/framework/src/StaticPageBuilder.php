...
class StaticPageBuilder
{
     ...
     * Construct the class.
     *
     * @param  LegacyMarkdownDocument|BladePage  $page  the Page to compile into HTML
     * @param  bool  $selfInvoke  if set to true the class will invoke when constructed
     */
    public function __construct(protected LegacyMarkdownDocument|BladePage $page, bool $selfInvoke = false)
    {
        if ($selfInvoke) {
            $this->__invoke();
        }
