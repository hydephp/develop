...
class StaticSiteServiceTest extends TestCase
{
    ...
    public function test_build_command_transfers_media_asset_files()
    {
        ...
        \Hyde\Facades\Filesystem::unlink('_media/test-image.png');
        \Hyde\Facades\Filesystem::unlink('_site/media/test-image.png');
    }
    ...
    public function test_all_page_types_can_be_compiled()
    {
        ...
        \Hyde\Facades\Filesystem::unlink('_site/html.html');
        \Hyde\Facades\Filesystem::unlink('_site/blade.html');
        \Hyde\Facades\Filesystem::unlink('_site/markdown.html');
        \Hyde\Facades\Filesystem::unlink('_site/posts/post.html');
        \Hyde\Facades\Filesystem::unlink('_site/docs/docs.html');
    }
    ...
    public function test_rss_feed_is_generated_when_conditions_are_met()
    {
        ...
        \Hyde\Facades\Filesystem::unlink('_site/feed.xml');
    }
    ...
    {
        \Hyde\Facades\Filesystem::touch('_site/foo.html');
        $this->artisan('build')
    ...
    public function test_output_directory_is_not_emptied_if_disabled_in_config()
    {
        ...
        \Hyde\Facades\Filesystem::touch('_site/keep.html');
        ...
        \Hyde\Facades\Filesystem::unlink('_site/keep.html');
    }
    ...
    public function test_aborts_when_non_standard_directory_is_emptied()
    {
        ...
        mkdir(Hyde::path('foo'));
        \Hyde\Facades\Filesystem::touch('foo/keep.html');
