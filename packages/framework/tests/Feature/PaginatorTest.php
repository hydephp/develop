...
class PaginatorTest extends TestCase
{
    ...
    {
        $collection = (new Paginator(range(1, 50)))->getPaginatedItems();
    ...
    {
        $collection = (new Paginator(range(1, 50), 10))->getPaginatedItems();
    ...
    public function testGetItemsForPageReturnsTheCorrectChunk()
    {
        ...
        $this->assertSame(range(1, 10), $paginator->setCurrentPage(1)->getItemsForPage()->toArray());
        $this->assertSame(array_combine(range(10, 19), range(11, 20)), $paginator->setCurrentPage(2)->getItemsForPage()->toArray());
        $this->assertSame(array_combine(range(20, 29), range(21, 30)), $paginator->setCurrentPage(3)->getItemsForPage()->toArray());
        $this->assertSame(array_combine(range(30, 39), range(31, 40)), $paginator->setCurrentPage(4)->getItemsForPage()->toArray());
        $this->assertSame(array_combine(range(40, 49), range(41, 50)), $paginator->setCurrentPage(5)->getItemsForPage()->toArray());
    }
    ...
    {
        $service = new Paginator(range(1, 50), 10);
    ...
    public function testCannotSetInvalidCurrentPageNumberInConstructor()
    {
        ...
        new Paginator(range(1, 50), 10, currentPageNumber: 6);
    }
