...
class DiscoveryServiceTest extends TestCase
{
    ...
    {
        \Hyde\Facades\Filesystem::touch(DiscoveryService::getModelSourceDirectory(MarkdownPost::class).'/test.md');
        \Hyde\Facades\Filesystem::touch(DiscoveryService::getModelSourceDirectory(MarkdownPage::class).'/test.md');
        \Hyde\Facades\Filesystem::touch(DiscoveryService::getModelSourceDirectory(DocumentationPage::class).'/test.md');
        \Hyde\Facades\Filesystem::touch(DiscoveryService::getModelSourceDirectory(BladePage::class).'/test.blade.php');
    }
    ...
    public function test_media_asset_extensions_can_be_added_by_comma_separated_values()
    {
        ...
        \Hyde\Facades\Filesystem::touch('_media/test.1');
        \Hyde\Facades\Filesystem::touch('_media/test.2');
        \Hyde\Facades\Filesystem::touch('_media/test.3');
    ...
    {
        \Hyde\Facades\Filesystem::touch($path);
