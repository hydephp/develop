...
class SitemapServiceTest extends TestCase
{
    ...
    public function test_url_item_is_generated_correctly()
    {
        ...
        \Hyde\Facades\Filesystem::unlink('_pages/0-test.blade.php');
    }
    ...
    {
        config(['hyde.url' => 'foo']);
        \Hyde\Facades\Filesystem::unlink(['_pages/index.blade.php', '_pages/404.blade.php']);
        ...
        \Hyde\Facades\Filesystem::unlink($files);
