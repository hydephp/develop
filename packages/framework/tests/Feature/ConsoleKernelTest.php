 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(\Hyde\Foundation\ConsoleKernel
...
at any time, we have tests here to detect if their code changes, so we can catch it early.::class)]
