...
class PublishCommandTest extends TestCase
{
    ...
    public function testRemovedLegacyPublishHomepageCommandRaisesCommandNotFound()
    {
        $this->expectException(CommandNotFoundException::class);
        $this->expectExceptionMessage('The command "publish:homepage" does not exist.');

        $this->artisan('publish:homepage')->run();
    }

    public function testRemovedLegacyPublishConfigsCommandRaisesCommandNotFound()
    {
        $this->expectException(CommandNotFoundException::class);
