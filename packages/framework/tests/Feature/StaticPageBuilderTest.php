...
class StaticPageBuilderTest extends TestCase
{
    ...
    public function test_can_build_documentation_page()
    {
        ...
        $this->assertFileExists(Hyde::path('_site/'.Hyde::getDocumentationOutputDirectory().'/foo.html'));
        $this->validateBasicHtml(file_get_contents(Hyde::path('_site/'.Hyde::getDocumentationOutputDirectory().'/foo.html')));
    }
