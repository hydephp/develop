...
class RouteTest extends TestCase
{
    public function test_constructor_creates_route_from_page_model()
    {
        ...
        $this->assertInstanceOf(\Hyde\Framework\Models\Route::class, $route);
    }
    ...
    public function test_get_from_key_returns_route_from_router_index()
    {
        ...
        $this->assertInstanceOf(\Hyde\Framework\Models\Route::class, Route::get('index'));
    }
    ...
    public function test_get_from_source_returns_route_from_router_index()
    {
        ...
        $this->assertInstanceOf(\Hyde\Framework\Models\Route::class, Route::getFromSource('_pages/index.blade.php'));
    }
