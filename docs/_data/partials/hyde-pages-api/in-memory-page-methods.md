...
<!-- Generated by HydePHP DocGen script at 2026-07-15 21:19:42 in 0.13ms -->
...
```php
$page = new InMemoryPage(string $identifier, \Hyde\Markdown\Models\FrontMatter|array $matter, string|Closure(static): string, string $view): void
```
