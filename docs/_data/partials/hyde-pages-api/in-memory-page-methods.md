...
<!-- Generated by HydePHP DocGen script at 2026-07-15 01:57:57 in 0.15ms -->
...
The in-memory page class offers three content strategies. You can pass a literal string or a lazy closure to the $contents parameter, or pass a view name or Blade file to the $view parameter. Closures are invoked each time the contents are requested with the current page as their first argument. The argument may be omitted when page context is not needed. Other dependencies are not resolved automatically.
