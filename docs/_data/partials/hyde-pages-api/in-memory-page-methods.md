...
<!-- Generated by HydePHP DocGen script at 2026-07-15 01:34:44 in 0.17ms -->
...
The in-memory page class offers three content strategies. You can pass a literal string or a lazy closure to the $contents parameter, or pass a view name or Blade file to the $view parameter. Closures are invoked each time the contents are requested. The current page is injected when requested with a compatible type declaration. No other dependencies are resolved.
