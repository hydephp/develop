...
<!-- Generated by HydePHP DocGen script at 2026-07-31 02:00:45 in 0.27ms -->
...
Drafts are excluded from publication builds while the property is true, but remain available in realtime compiler previews. Unlike a scheduled post, a draft never becomes publishable on its own, as it is withheld pending an explicit front matter change rather than a date.
