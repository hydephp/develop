...
<!-- Generated by HydePHP DocGen script at 2023-03-10 10:46:36 in 3.25ms -->
...
```php
// torchlight! {"lineNumbers": false}
HydePage::all(): <abbr title="\Hyde\Foundation\Kernel\PageCollection<static>">PageCollection<static></abbr>
```
...
```php
// torchlight! {"lineNumbers": false}
$page->getRoute(): <abbr title="\Hyde\Support\Models\Route">Route</abbr> // The page's route.
```
