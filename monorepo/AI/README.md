...
- Use strict types whenever possible, including closures and arrow functions. Avoid `mixed` types whenever possible. Use PHPDoc annotations to annotate things like array types/shapes and generics. Do not use PHPDocs to annotate types that can be conveyed using native PHP typing. PHPDoc comments with just one annotation should be compressed to one line. 
